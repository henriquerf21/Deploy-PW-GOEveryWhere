  ...
  <div class="page">
    <div class="page__head card">
      <div>
        ...
        <p class="page__desc">Catálogo de demonstração: adicionar, editar e ativar/desativar produtos.</p>
      </div>
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-if="!filtered.length">
            <td colspan="7" class="empty-cell">Sem produtos. Clica em «Adicionar produto» para criar o primeiro.</td>
          </tr>
...
import { Plus, Search, Package, Layers } from 'lucide-vue-next';
...
const filtered = computed(() => {
  ...
  if (!s) return list;
  return list.filter((r) => r.name.toLowerCase().includes(s) || r.sku.toLowerCase().includes(s));
});
