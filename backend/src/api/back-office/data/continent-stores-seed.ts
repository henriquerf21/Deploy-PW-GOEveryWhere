...
export const CONTINENTE_STORES_SEED: ContinentStoreSeed[] = [
  ...
  { code: 'CT-BD-SAO-VICENTE', name: 'Continente Bom Dia São Vicente', city: 'Braga', district: 'Braga', address: 'R. de São Vicente', postalCode: '4710-331 Braga', lat: 41.5536, lng: -8.4335, openingHours: '08:30-21:00', phone: '+351 253 079 000', format: 'Bom Dia' },
