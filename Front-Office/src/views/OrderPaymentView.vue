          ...
          <section class="pay-section" aria-labelledby="pay-methods-h">
            ...
            <div class="payment-methods" role="radiogroup" aria-label="Método de pagamento">
              ...
              <button type="button" class="pay-method" :class="{ active: store.payment.method === 'applepay' }" @click="setMethod('applepay')">
                <svg class="pay-logo pay-logo--applepay" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path
                    fill="currentColor"
              ...
              <button type="button" class="pay-method" :class="{ active: store.payment.method === 'googlepay' }" @click="setMethod('googlepay')">
                <svg class="pay-logo pay-logo--googlepay" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path
                    fill="currentColor"
              ...
              <button type="button" class="pay-method" :class="{ active: store.payment.method === 'card' }" @click="setMethod('card')">
                <span class="pay-logo pay-logo--cards" aria-hidden="true">
                  <svg class="pay-logo__visa" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <title>Visa</title>
                    <path
                      fill="#1A1F71"
                  ...
                  <svg class="pay-logo__mc" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div v-if="store.payment.method === 'card'" class="payment-fields">
              <input v-model="store.payment.cardName" class="cf-input" type="text" placeholder="Nome no cartão" autocomplete="cc-name" style="margin-bottom: 10px;" />
            ...
            <p v-if="store.payment.method === 'applepay'" class="wallet-hint">
              Pagamento com Apple Pay / Apple Wallet no passo seguinte, quando o gateway estiver ligado.
            </p>
            <p v-if="store.payment.method === 'googlepay'" class="wallet-hint">
              Pagamento com Google Pay no passo seguinte, quando o gateway estiver ligado.
            </p>
          </section>
...
/** Logótipo MB WAY (MB + parêntesis vermelhos + WAY) — public/payment/mbway-logo.png */
...
import { 
  ...
  estimatedETA, setPaymentMethod, submitOrder,
